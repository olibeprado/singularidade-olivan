...
function LeftToolbar({
  ...
  const groups = [
    {
      ...
      items: [
        ...
        { key: "cross" as ToolKey, icon: <Circle size={15} />, label: "Mira" },
        { key: "magnet" as ToolKey, icon: <Eye size={15} />, label: "Magneto" },
      ],
    },
    {
      id: "lines",
      ...
      items: [
        { key: "trendline" as ToolKey, icon: <TrendingUp size={15} />, label: "Tendência" },
        { key: "ray" as ToolKey, icon: <MoveUpRight size={15} />, label: "Raio" },
        { key: "extended" as ToolKey, icon: <ArrowUp size={15} />, label: "Estendida" },
        { key: "hline" as ToolKey, icon: <ArrowRight size={15} />, label: "Horizontal" },
        { key: "vline" as ToolKey, icon: <ArrowDown size={15} />, label: "Vertical" },
        { key: "measure" as ToolKey, icon: <Plus size={15} />, label: "Medida" },
      ],
    },
    {
      id: "channels",
      ...
      items: [
        { key: "channel" as ToolKey, icon: <GitBranch size={15} />, label: "Canal" },
    ...
    },
    {
      ...
      items: [
        { key: "fib" as ToolKey, icon: <SlidersHorizontal size={15} />, label: "Retração" },
        { key: "fibext" as ToolKey, icon: <Grid2X2 size={15} />, label: "Extensão" },
        { key: "fibarc" as ToolKey, icon: <Ruler size={15} />, label: "Arcos" },
    ...
    },
    {
      ...
      icon: <Square size={16} />,
      items: [
        { key: "rect" as ToolKey, icon: <Square size={15} />, label: "Retângulo" },
        { key: "triangle" as ToolKey, icon: <Spline size={15} />, label: "Triângulo" },
        { key: "ellipse" as ToolKey, icon: <Network size={15} />, label: "Elipse" },
      ],
    },
    {
      id: "text",
      ...
      icon: <Type size={16} />,
      items: [
        { key: "text" as ToolKey, icon: <Type size={15} />, label: "Texto" },
      ],
    },
  ];
  ...
  const isGroupActive = (group: (typeof groups)[number]) => {
    ...
    return group.items.some((item) => item.key === selectedTool);
  };
