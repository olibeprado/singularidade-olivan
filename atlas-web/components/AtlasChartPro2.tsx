...
// ============================================================
// REPLACED LEFT TOOLBAR WITH DrawingToolbar
// The old LeftToolbar is removed.
// ============================================================
...
function ChartPanel({
  ...
  const handleOverlayMouseDown = (e: React.MouseEvent<SVGSVGElement>) => {
    ...
    // If not hit and we are in drawing mode (not cursor)
  ...
  const handleOverlayMouseMove = (e: React.MouseEvent<SVGSVGElement>) => {
    if (draftStart && drawingState.activeTool !== "cursor") {
      ...
      // For now we just preview, we'll commit on mouseup
      // We'll store in a temporary state (draftDrawing)
      // For simplicity, we'll create a temporary drawing and add it on mouseup
      // We'll use a local state for draft drawing
    }
  };
    ...
    >
      ...
      <div style={{ position: "relative", flex: 1, minHeight: 0 }}>
        ...
        >
          ...
          {/* TODO: show draft drawing while dragging */}
        </svg>
        <div
          ref={volOverlayRef}
          style={{
